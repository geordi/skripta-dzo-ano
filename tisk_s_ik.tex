...
\newenvironment{cile}[1]{\subsection*{Cíle\ikona{5}}#1
...
\newenvironment{shrnuti}{\subsection*{Pojmy k zapamatování\ikona{3}}
\begin{list}{---}%
{\topsep=4pt\partopsep=0pt\itemsep=3pt\parsep=0pt%
...
\newenvironment{konot}[1][1.]{\subsection*{Kontrolní otázky\ikona{1}}
\begin{aokt}{\indent#1}}%
{\end{aokt}}

\newenvironment{priklady}[1][1.]{\subsection*{Pøíklady k procvièení\ikona{2}}\small
...
\newenvironment{vysledky}[2][1.]{\subsection*{Klíè k pøíkladùm k procvièení\ikona{9}}\small
...
\subsection*{\refstepcounter{klicautotest}Klíè k autotestu~\theklicautotest\ikona{9}}%
\addcontentsline{toc}{section}{Klíè k~autotestu~\theklicautotest}%
\markright{Klíè k~autotestu~\theklicautotest}%
}

\newenvironment{pruvodce}{\subsection*{Prùvodce studiem\ikona{6}}
\sffamily\slshape }
{}

\newenvironment{detaily}{\subsection*{Pro zájemce:\ikona{7}}
\small }
{\bigskip\par }
