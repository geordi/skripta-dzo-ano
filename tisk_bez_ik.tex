...
\newcommand{\da}{\mathrm{d}\mkern1mu a}
\newcommand{\db}{\mathrm{d}\mkern1mu b}
...
pdfstartview={FitH 714 },pdftitle={Matematické základy digitálního zpracování obrazu},pdfsubject={Skripta},
pdfauthor={Eduard Sojka, Jan Gaura, Michal Krumnikl}
